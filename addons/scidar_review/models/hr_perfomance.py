...
class HrPerformance(models.Model):
    ...
    rating_ids = fields.One2many('hr.performance.rating', 'performance_id', string="Competency Ratings")
...
class HrPerformanceRating(models.Model): 
    ...
    competency = fields.Selection([
        ...
        ('coherence', 'Coherence (Storylining)'),
        ('presence', 'Presence / Confidence / Public Speaking'),
        ('data_analytics', 'Data Analytics, Excel and Chart'),
        ('word', 'Word & Formatting'),
        ('communication', 'Communication Skills'),
        ('problem_solving', 'Problem Solving'),
        ('work_management', 'Work Planning & Prioritization'),
        ('teamwork', 'Teamwork / Cooperation'),
        ('professionalism', 'Professionalism & Personal Leadership'),
