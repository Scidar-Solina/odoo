...
class HrPerformanceFirmLeadership(models.Model): 
    _name = "hr.performance.firm.leadership" 
    ...
    descriptionsFirm = fields.Selection([
    ...
    employee_rating_firm = fields.Selection([
        ('1', '1: Unsatisfactory'),
    ...
    reviewer_rating_firm= fields.Selection([
        ('1', '1: Unsatisfactory'),
        ('2', '2: Needs Improvement'),
        ('3', '3: Meets Expectation'),
        ('4', '4: Exceeds Expectation'),
    ...
    comments_firm = fields.Html(string="Rating Comments")


    @api.onchange('descriptionsFirm')
    def _onchange_description(self):
        ...
        if self.descriptionsFirm:
            self.objectivesFirm = competency_objectives_map.get(self.descriptionsFirm, '')
        else:
            self.objectivesFirm = ''