...
class HrPerformanceProduct(models.Model): 
    _name = "hr.performance.product.work" 
    ...
    descriptionspro = fields.Selection([
    ...
    employee_ratingpro = fields.Selection([
        ('1', '1: Unsatisfactory'),
    ...
    reviewer_ratingpro = fields.Selection([
        ('1', '1: Unsatisfactory'),
        ('2', '2: Needs Improvement'),
        ('3', '3: Meets Expectation'),
        ('4', '4: Exceeds Expectation'),
    ...
    commentspro = fields.Html(string="Rating Comments")


    @api.onchange('descriptionspro')
    def _onchange_description(self):
        ...
        if self.descriptionspro:
            self.objectivespro = competency_objectives_map.get(self.descriptionspro, '')
        else:
            self.objectivespro = ''